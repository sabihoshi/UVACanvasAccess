...
namespace UVACanvasAccess.ApiParts
{
    public partial class Api
    {
        ...
        {
            [ApiRepresentation("name")] Name,
            [ApiRepresentation("name_descending")] NameDescending,
            [ApiRepresentation("score")] Score,

            [ApiRepresentation("score_descending")]
            ScoreDescending,
            [ApiRepresentation("participations")] Participations,

            [ApiRepresentation("participations_descending")]
            ParticipationsDescending,
            [ApiRepresentation("page_views")] PageViews,
        ...
        /// <summary>
        ///     Gets the page view and participation counts across all current or completed courses in the department during the
        ///     default term.
        /// </summary>
        ...
        public Task<DepartmentParticipation> GetDefaultTermDepartmentParticipationData(bool currentCourses = true,
            ...
            => BaseGetDepartmentParticipationData(currentCourses ? "current" : "completed",
                accountId.IdOrSelf());
        ...
        public Task<DepartmentParticipation> GetDepartmentParticipationData(ulong termId, ulong? accountId = null)
            => BaseGetDepartmentParticipationData($"terms/{termId}", accountId.IdOrSelf());
        ...
        public Task<DepartmentStatistics> GetDefaultTermDepartmentStatistics(bool currentCourses = true,
            ulong? accountId = null)
            => BaseGetDepartmentStatistics(currentCourses ? "current" : "completed", accountId.IdOrSelf());
        ...
        public Task<DepartmentStatistics> GetDepartmentStatistics(ulong termId, ulong? accountId = null)
            => BaseGetDepartmentStatistics($"terms/{termId}", accountId.IdOrSelf());

        /// <summary>
        ///     Gets the distribution of grades for students across all current or completed courses in the department during the
        ///     default term.
        /// </summary>
        /// <param name="currentCourses">
        ///     If true, the data returned will be across current courses. Otherwise, it will be across completed courses.
        ...
        public Task<Dictionary<byte, ulong>> GetDefaultTermDepartmentGradeData(bool currentCourses = true,
            ulong? accountId = null)
            => BaseGetDepartmentGradeData(currentCourses ? "current" : "completed",
        ...
        public Task<Dictionary<byte, ulong>> GetDepartmentGradeData(ulong termId, ulong? accountId = null)
            => BaseGetDepartmentGradeData($"terms/{termId}", accountId?.ToString() ?? "self");
        ...
        public async Task<UserParticipation> GetUserCourseParticipationData(ulong userId, ulong courseId)
        {
            ...
            return new UserParticipation(
                JsonConvert.DeserializeObject<UserParticipationModel>(await response.Content.ReadAsStringAsync()));
        }
